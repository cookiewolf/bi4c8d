export const terminal1 = { 
    ...
    contents: {
      name: 'contents',
      description: 'a test command with no arguments that just prints some text',
      func: ({ print }) => { print($contents) }
    },
    media: {
      name: 'media',
      description: 'a test command with no arguments that just prints some text',
      func: ({ print }) => { print($media) }
    },
    govt: {
      name: 'govt',
      description: 'a test command with no arguments that just prints some text',
      func: ({ print }) => { print($govt) }
    },
    accountability: {
      name: 'accountability',
      description: 'a test command with no arguments that just prints some text',
      argDescriptions: ['One of paulgray, handling,'],
      func: ({ print }, option) => {
        switch(option) {
          case "paulgray":
            print($paulgray)
          ...
          case "references":
              ...
              break;
          default:
          print ("Please type accountability plus whatever")
       }
      }
    },
}
...
const $info = `
<p>
	In October 2007, a junior official at His Majesty’s Revenue and Customs (HMRC) popped two unencrypted discs into an envelope and posted it to its intended destination at the National Audit Office. Somewhere between its collection in Washington, Tyne and Wear and the NAO in London, the discs went missing.
</p>
<p>
...
const $contents =
`<p>
	The 25 million records contained the names, addresses, dates of birth, National Insurance numbers and (in the case of claimants and payees) bank details of:
</p>
<ul>
	<li>
...
const $media =
`<p>
	<a href="http://news.bbc.co.uk/1/hi/uk_politics/7104945.stm">
		http://news.bbc.co.uk/1/hi/uk_politics/7104945.stm
		<br />
	</a>
	<a href="https://www.theguardian.com/politics/2007/nov/20/economy.personalfinancenews">
		https://www.theguardian.com/politics/2007/nov/20/economy.personalfinancenews
		<br />
	</a>
	<a href="https://web.archive.org/web/20080319123519/http://www.kablenet.com/kd.nsf/FrontpageRSS/702533E1FF0993F88025740F0042FB9B!OpenDocument">
	...
	<a href="http://news.bbc.co.uk/2/hi/uk_news/politics/7472814.stm">
		http://news.bbc.co.uk/2/hi/uk_news/politics/7472814.stm
	</a>
</p>`
const $govt =
`<p>
...
const $paulgray =
`<p>
<a href="https://web.archive.org/web/20081118223337/http://www.channel4.com/news/articles/politics/domestic_politics/paul+gray+back+at+work/1136847">
  https://web.archive.org/web/20081118223337/http://www.channel4.com/news/articles/politics/domestic_politics/paul+gray+back+at+work/1136847
</a>
</p>`
const $handling =
`<p>
The loss of two discs by HM Revenue and Customs (HMRC) started an intensive process as all Departments re-examined their practices:
</p>
<ul>
<li>
...
const $review =
`<p>
The Poynter Review (PricewaterhouseCoopers review) included recommendations to:
</p>
<ul>
<li>
...
const $sorry =
`<p>
<a href="https://www.whatdotheyknow.com/cy/request/23313/response/57549/attach/html/4/Data%20Loss%20Apology%20Letter.pdf.html">
...
const $references =
`<p>
<a href="http://news.bbc.co.uk/1/hi/uk_politics/7128851.stm">
  http://news.bbc.co.uk/1/hi/uk_politics/7128851.stm
  <br />
</a>
<a href="https://wiki.openrightsgroup.org/wiki/Discgate">
  https://wiki.openrightsgroup.org/wiki/Discgate
  <br />
</a>
<a href="http://news.bbc.co.uk/2/hi/business/7105592.stm">
  http://news.bbc.co.uk/2/hi/business/7105592.stm
  <br />
</a>
<a href="https://publications.parliament.uk/pa/cm200708/cmhansrd/cm071120/debtext/71120-0004.htm">
